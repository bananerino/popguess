...
export default function Footer(){
    ...
    return(
        <div id="footer--container">
            <a className="link-light m-2"href="https://wikitrivia.tomjwatson.com/">Game inspired by</a>
            <img id="wiki--img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Wikidata_Stamp_Rec_Dark.svg/320px-Wikidata_Stamp_Rec_Dark.svg.png" />
            <a href="https://github.com/bananerino/popguess" >
